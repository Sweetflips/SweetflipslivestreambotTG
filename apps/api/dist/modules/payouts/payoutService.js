...
export class PayoutService {
    ...
    async createAward(userId, gameId, amount, currency = 'USDT') {
    ...
    async updateAwardStatus(awardId, status, tipCommand) {
