...
export class LinkController {
    ...
    async generateLinkCode(request, reply) {
        try {
    ...
    async verifyLinkCode(request, reply) {
        try {
    ...
    async unlinkAccount(request, reply) {
        try {
            const { userId } = request.body;
            if (!userId || typeof userId !== 'string') {
                return reply.status(400).send({
    ...
    async getLinkStatus(request, reply) {
        try {
    ...
    async setCwalletHandle(request, reply) {
        try {
    ...
    async getActiveLinkCodes(request, reply) {
        try {
    ...
    async validateLinkCode(request, reply) {
        try {
    ...
    async cleanupExpiredCodes(request, reply) {
        try {
