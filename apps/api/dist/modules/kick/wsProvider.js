...
export class WebSocketKickProvider extends EventEmitter {
    config;
    ws = null;
    reconnectTimer = null;
    reconnectAttempts = 0;
...
export class MockKickProvider extends EventEmitter {
    config;
    messageCallbacks = [];
    connected = false;
