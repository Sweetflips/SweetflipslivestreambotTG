...
export class TriviaLogic {
    ...
    static calculateScores(rounds) {
        ...
        for (const round of rounds) {
            ...
            const firstCorrectPerUser = new Map();
    ...
    static generateLeaderboard(scores, topN = 10) {
        return scores
            .sort((a, b) => {
    ...
    static formatRoundResult(result) {
    ...
    static calculatePayoutDistribution(leaderboard, totalPrizePool) {
        if (leaderboard.length === 0) {
            return [];
        }
...
//# sourceMappingURL=triviaLogic.js.map