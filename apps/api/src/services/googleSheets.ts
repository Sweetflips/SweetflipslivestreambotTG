...
export class GoogleSheetsService {
  ...
  async addLinkedAccount(account: LinkedAccount): Promise<boolean> {
    if (!this.sheets) {
  ...
  async getAllLinkedAccounts(): Promise<LinkedAccount[]> {
    if (!this.sheets) {
  ...
  async updateAccountRole(telegramId: string, newRole: string): Promise<boolean> {
    if (!this.sheets) {
