...
const isWalletObject = (value) => typeof value === "object" && value !== null;
const parseBalance = (wallet) => {
...
export const createLiveBalanceService = (options = {}) => {
    ...
    const fetchCurrentBalance = async () => {
        try {
            ...
            const message = error instanceof Error ? error.message : "Unknown live balance error";
