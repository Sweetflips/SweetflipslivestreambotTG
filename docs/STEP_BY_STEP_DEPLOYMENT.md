...
## **Let's Deploy Your SweetflipsStreamBot Together!**
...
echo "🚀 SweetflipsStreamBot VPS Deployment"
echo "====================================="
...
1. ✅ **Update your system** and install all required software
2. ✅ **Install Node.js 20**, pnpm, Docker, PostgreSQL, Redis, Nginx
3. ✅ **Configure databases** with secure passwords
4. ✅ **Set up firewall** and security
5. ✅ **Clone your repository** (you'll need to provide the Git URL)
...
Once the script completes, you'll need to:

1. **Edit the environment file** with your actual API keys:
   ```bash
...
2. **Add your credentials**:
   - Telegram bot token
   - Kick channel ID and WebSocket credentials
   - Cwallet API key
   - Telegram group IDs
...
- **Health**: `http://173.212.207.42/healthz`
- **Game State**: `http://173.212.207.42/state`
- **Overlay**: `http://173.212.207.42/overlay/state`

## 🎯 **Ready to Deploy?**

Just follow these steps:

1. **Connect to your VPS**: `ssh root@173.212.207.42`
2. **Run the deployment script** (copy and paste the commands above)
3. **Provide your Git repository URL** when prompted
4. **Configure your API keys** in the `.env` file
5. **Restart the service** and test!

The entire process should take about 10-15 minutes. Let me know if you need help with any step! 🚀
