...
if (process.env.DATABASE_URL) {
  ...
  console.log(
    "This means Railway has not provided the database connection string."
  );
  console.log(
    "Make sure you have added a PostgreSQL database to your Railway project."
  );
}
...
console.log(
  "3. Check that DATABASE_URL is automatically set in your service variables"
);
