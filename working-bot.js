...
// Start the bot
console.log("🤖 Starting working bot with all commands...");
bot
  .launch()
  .then(() => {
    console.log("✅ Working bot is running!");
    console.log("📱 All commands are now functional:");
    console.log("🎮 Gaming: /guess, /balanceboard, /bonusboard");
    console.log("🔗 Account: /start, /help, /kick");
    console.log(
      "⚙️ Admin: /balance, /bonus, /addbonus, /removebonus, /setrole, /listusers"
    );
  })
  .catch(console.error);
