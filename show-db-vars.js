...
console.log("🔍 All environment variables containing 'DATABASE', 'POSTGRES', 'PG', or 'RAILWAY':");
console.log("=" * 80);
...
console.log("1. Look for variables with actual resolved values (not template variables)");
console.log("2. Use those values to construct your DATABASE_URL");
console.log("3. The format should be: postgresql://user:password@host:port/database");
